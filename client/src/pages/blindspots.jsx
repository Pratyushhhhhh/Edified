...
export default function Blindspots() {
  ...
  // We'll add a parameter to useStories or pass a filter down
  // Let's modify useStories to accept maxArticles parameter
      ...
      <main style={{ maxWidth: "1100px", margin: "0 auto", padding: "48px 24px" }}>
        ...
        <div style={{ marginBottom: "40px", borderBottom: "1px solid #ddd9ce", paddingBottom: "20px" }}>
          ...
          <p style={{ fontSize: "13px", color: "#5a5c54" }}>
            This page contains articles which are not published by many and only a few news media outlets published them.
          </p>
        </div>
        ...
        {!loading && !error && stories.length === 0 && (
          <p style={{ textAlign: "center", color: "#9a9b95", padding: "80px 0" }}>No blindspots found.</p>
        )}
